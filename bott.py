...
BOT_TOKEN = "8290942305:AAHgxpUXoyqbx3moQLEhaLrZEL4pfB8-gq0"
...
HARDCODED_ADMIN_IDS = [6198703244,5646492454 ]
    ...
    try:
        ...
        if not allowed:
            await update.message.reply_text(
                "Access restricted.\n\n"
                "Join Channel To Check: https://t.me/minatotheflash143\n\n"
                "Owner: @minato_namikaze143"
            )
            return False
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        "👨‍💻 <b>Developer:</b> @minato_namikaze143\n"
        "📢 <b>Join our Channel :</b> https://t.me/minatotheflash143",
        parse_mode=ParseMode.HTML
    )
